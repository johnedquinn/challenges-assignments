...
ASSIGNMENTS     = {}
DREDD_QUIZ_URL  = 'https://dredd.h4x0r.space/quiz/cse-30872-fa19/'
DREDD_QUIZ_MAX  = 2.0
if bool(os.environ.get('DEBUG', False)):
    DREDD_CODE_URL = 'https://dredd.h4x0r.space/debug/cse-30872-fa19/'
else:
    DREDD_CODE_URL = 'https://dredd.h4x0r.space/code/cse-30872-fa19/'
DREDD_CODE_MAX  = 6.0
